...
def create_model():
    ...
    input_1 = Input(shape=(5, EMBEDDING_SIZE), name='input_1')  # Radiant team LSTM
    input_2 = Input(shape=(5, EMBEDDING_SIZE), name='input_2')  # Dire team LSTM
...
model.fit(train_data, train_labels, validation_data=(val_data, val_labels),
          epochs=50, batch_size=2000, shuffle=True)
