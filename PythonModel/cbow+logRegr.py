...
model.save(f'cbow_model_epoch_{epochs}_emb_{EMBEDDING_SIZE}_workers_{workers}_val_{val}_shuffle_{shuffle}_con_len_{context_len}.h5')
...
model.fit(train_data, train_labels, validation_data=(val_data, val_labels),
          epochs=1000, batch_size=512, shuffle=True,
          use_multiprocessing=True)
